        ...
        <div class="card">
            ...
            <div class="card-block">
                <div id="js-table-list">
                    <table id="ajax_datatable" data-jsonfile="restaurant.php" class="js-table-checkable table table-vcenter table-hover" data-tablesaw-mode="stack" data-plugin="animateList" data-animate="fade" data-child="tr" data-selectable="selectable">
                        <thead>
                        <tr>
                            ...
                            <th><i class="ion-image"></i> Restaurant</th>
                            <th>Owner Name</th>
                            <th>Wallet Amount</th>
                            <th>Plan</th>
                            <th>Address</th>
...
<div class="site-action">
    ...
    <div class="site-action-buttons">
        <button type="button" data-ajax-response="deletemarked" data-ajax-action="deleteRestaurant"
