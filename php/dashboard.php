...
if(checkloggedin())
{
    ...
    $days = $scans = [];
    $total_scans = $total_categories = $total_menus = $wallet_amount = 0;
    ...
    if(isset($restaurant['user_id'])) {
        ...
        $wallet_amount = get_restaurant_option($restaurant['id'],'wallet_amount',0);
        $wallet_amount = price_format($wallet_amount, $currency);
    }
    ...
    $page->SetParameter ('WALLET_AMOUNT', $wallet_amount);
